...
if __name__ == "__main__":
    ...
    #Plotting setup
    fig_breast_cancer = plt.figure(figsize=(15,4), tight_layout=True)
    gs = fig_breast_cancer.add_gridspec(6, 10, wspace = 0.03, hspace = 0.02) #
    border_width = 1.5
    tick_lab_size = 12
    ax_lab_size = 13
    all_genes = ['blind_pruning','cnode',"L0",'pathreg','lambda_pruning']
    ...
    ax = fig_breast_cancer.add_subplot(gs[0:5, 0:10])
    ...
    wide_file = "/home/ubuntu/lottery_tickets_phoenix/all_manuscript_models/breast_cancer/all_permtests_" + analysis_type +"_wide.csv"
    ...
    pval_file = "/home/ubuntu/lottery_tickets_phoenix/all_manuscript_models/breast_cancer/all_permtests_" + analysis_type +"_wide_pval.csv"
    ...
    print(z)
    c = ax.pcolormesh(z, cmap='RdPu', #z.transpose() #vmin=0, vmax= z_max, #120
...
#    fig_breast_cancer.savefig('{}/manuscript_fig_breast_cancer_permtest_{}.png'.format(output_root_dir, analysis_type), bbox_inches='tight')
    ...
    ax.tick_params(axis='x', labelsize= tick_lab_size, rotation = 45, bottom=False, top=True, labelbottom=False, labeltop=True)
    ...
    cbar.set_ticklabels(["0", '10', '20'], ha='left')
    cbar.ax.tick_params(labelsize = tick_lab_size+2) 
    cbar.outline.set_linewidth(2)
    
    
    fig_breast_cancer.savefig('{}/manuscript_fig_breast_cancer_permtest_{}_icml.png'.format(output_root_dir, analysis_type),  bbox_inches='tight', dpi = 200) #
